...
export type OrderStatus = "PENDING" | "PAID" | "SENT" | "COMPLETED";
...
export type SizeSymbol = "XS" | "S" | "M" | "L" | "XL" | "XXL";
...
export type CreateItemMutation = { __typename?: "Mutation" } & {
	...
	> & {
			sizes?: Maybe<
				Array<{ __typename?: "Size" } & Pick<Size, "sizeSymbol" | "quantity">>
			>;
		};
};
...
export type ResetPasswordMutation = { __typename?: "Mutation" } & {
	requestResetPassword: { __typename?: "SuccessMessage" } & Pick<
		SuccessMessage,
		"message"
	>;
};
...
export type ItemsQuery = { __typename?: "Query" } & {
	items: { __typename?: "ItemsAndCount" } & Pick<
		ItemsAndCount,
		"maxPrice" | "count"
	> & {
			select: Array<
...
export type UsersQuery = { __typename?: "Query" } & {
	users: { __typename?: "UsersAndCount" } & Pick<UsersAndCount, "count"> & {
			select: Array<
				Maybe<
					{ __typename?: "User" } & Pick<
						User,
...
export type UserOrdersQuery = { __typename?: "Query" } & {
	userOrders?: Maybe<
		{ __typename?: "UserOrdersAndCount" } & Pick<
			UserOrdersAndCount,
			"count"
		> & {
				select: Array<
					Maybe<
						...
						> & {
								orderedItems: Array<
									{ __typename?: "Ordered_Item" } & Pick<
										Ordered_Item,
										"id" | "sizeSymbol"
									> & {
											item: { __typename?: "Item" } & Pick<
												Item,
												"gender" | "id" | "name" | "price"
											>;
										}
								>;
							}
...
export type DeleteItemMutationResult =
	ApolloReactCommon.MutationResult<DeleteItemMutation>;
...
export const SubscribeToNewsletterDocument = gql`
  ...
  subscribeToNewsletter(newsletter: $newsletter) {
    ...
    `;
export type SubscribeToNewsletterMutationFn =
...
export type SubscribeToNewsletterMutationResult =
	ApolloReactCommon.MutationResult<SubscribeToNewsletterMutation>;
export type SubscribeToNewsletterMutationOptions =
	ApolloReactCommon.BaseMutationOptions<
		SubscribeToNewsletterMutation,
		SubscribeToNewsletterMutationVariables
	>;
...
export type UpdateAddressMutationResult =
	ApolloReactCommon.MutationResult<UpdateAddressMutation>;
export type UpdateAddressMutationOptions =
	ApolloReactCommon.BaseMutationOptions<
		UpdateAddressMutation,
		UpdateAddressMutationVariables
	>;
...
export type UpdateItemMutationResult =
	ApolloReactCommon.MutationResult<UpdateItemMutation>;
...
export type UpdatePersonalInfoMutationResult =
	ApolloReactCommon.MutationResult<UpdatePersonalInfoMutation>;
export type UpdatePersonalInfoMutationOptions =
	ApolloReactCommon.BaseMutationOptions<
		UpdatePersonalInfoMutation,
		UpdatePersonalInfoMutationVariables
	>;
...
export function useUserOrdersQuery(
	...
	return ApolloReactHooks.useQuery<UserOrdersQuery, UserOrdersQueryVariables>(
		UserOrdersDocument,
		baseOptions,
	);
}
export function useUserOrdersLazyQuery(
	...
	return ApolloReactHooks.useLazyQuery<
		UserOrdersQuery,
		UserOrdersQueryVariables
	>(UserOrdersDocument, baseOptions);
}
...
>;
export type UserOrdersQueryResult = ApolloReactCommon.QueryResult<
	UserOrdersQuery,
	UserOrdersQueryVariables
>;
